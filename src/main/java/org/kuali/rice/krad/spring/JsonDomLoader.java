...
/**
 * This class converts JSON to DOM so Spring can load it.
 * It's probably not the best way to support JSON due to parsing/conversion overhead
 * but is a conservative way to supply a correctly parsed context.
 */
